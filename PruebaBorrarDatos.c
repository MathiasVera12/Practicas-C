...
int main(){
    ...
    archivo = fopen("DatosPaciente.csv","a"); //abrir el archivo para que se ingresen datos en el archivo plano de manera continua, con w es solo una vez
    ...
    do{ //Bucle do while para el menu
        ...
        case 1: printf("Por favor ingrese el numero de pacientes que desea ingresar: "); scanf("%d",&paciente);
                for(int i=0;i<paciente;i++){
                        ...
                        printf("\nLa masa corporal se calculara en base al peso y la altura ingresadas \n"); 
                        ...
                        printf("\nPor favor ingrese el nombre del Paciente del que desea borrar los datos: \n"); scanf("%s", &nombreBuscado);

                        if(strcmp(nombreBuscado,a.nombre)){
        ...
        case 2: //Aquí va la opcion de busqueda de datos
                printf("La posicion del Paciente %s es: %ld\n",nombreBuscado,posicion);
